...
const open = (scanResult) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const closedSubscription = new rxjs_1.Subject();
    try {
    ...
    closedSubscription.pipe((0, operators_1.first)(), (0, operators_1.tap)(() => {
...
class BleTransport extends hw_transport_1.default {
    ...
    constructor(device, writeCharacteristic, writeCmdCharacteristic, notifyObservable, deviceModel, bluetoothInfos) {
        ...
        this.exchange = (apdu) => __awaiter(this, void 0, void 0, function* () {
            if (!this.isConnected) {
                throw new errors_1.DisconnectedDeviceDuringOperation("Device not connected");
            }
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.disconnectTimeout = global.setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                (0, logs_1.log)(TAG, `Triggering a disconnect from ${this.id}`);
                if (this.isConnected) {
                    try {
                        yield BleTransport.disconnect(this.id);
                    }
                    finally {
                        resolve();
                    }
...
BleTransport.connect = (deviceId, onDisconnect) => {
